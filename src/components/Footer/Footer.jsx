      ...
      <div className="footer-container">
        ...
        <div className="footer-column">
          ...
          <div className="directions-to-administrator">
            ...
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              to="mailto:laptopshop_kg@gmail.com"
            >
               @ laptopshop_kg @gmail
            </Link>
          </div>
        ...
        <div className="footer-column">
          ...
          <div className="network-icons">
            <Link
              to="https://api.whatsapp.com/send?phone=996552177006"
              target="_blank"
              rel="noreferrer"
            >
              <svg
            ...
            <Link
              to="https://instagram.com/laptopshop.d"
              target="_blank"
              rel="noreferrer"
            >
              <svg
